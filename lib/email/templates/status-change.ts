...
<div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px">
  ...
  <p>Xin chào <strong>${escHtml(candidateName)}</strong>,</p>
  <p>Đơn ứng tuyển của bạn cho vị trí <strong>${escHtml(jobTitle)}</strong> tại <strong>${escHtml(companyName)}</strong> đã được cập nhật.</p>
